...
export const INITIAL_CCTV_FEEDS: CCTVFeed[] = [
  // ==============================================
  // --- ITER CAMPUS CAMERAS (3 Live, 3 Offline) ---
  // ==============================================
  {
    id: 'cam_01',
    ...
    zoneId: 'gate_1',
    status: 'online', // 🟢 LIVE (Matches run_cameras.py Port 5000)
    fps: 30,
    personCount: 0,
  ...
  },
  {
    ...
    status: 'offline', // 🔴 OFFLINE / BROKEN FOR DEMO
    fps: 0,
    personCount: 0,
    imageUrl: 'http://localhost:5006/video_feed', 
  ...
  },
  {
    ...
    status: 'online', // 🟢 LIVE (Matches run_cameras.py Port 5002)
    fps: 30,
    personCount: 0,
  ...
  },
  {
    ...
    zoneId: 'gate_2',
    status: 'online', // 🟢 LIVE (Matches run_cameras.py Port 5003)
    fps: 30,
    personCount: 0,
  ...
  // ==================================================
  // --- KALINGA STADIUM CAMERAS (1 Live, 5 Offline) ---
  // ==================================================
  {
    id: 'ks_cam_01',
    name: 'CAM-01: Gate 3',
    ...
    zoneId: 'ks_gate_3',
    status: 'online', // 🟢 LIVE (Matches run_cameras.py Port 5001)
    fps: 30,
    personCount: 0,
  ...
  },
  {
    ...
    location: 'Sky Walk',
    zoneId: 'ks_sky_walk',
    status: 'online', // 🔴 OFFLINE / BROKEN FOR DEMO
    fps: 0,
    personCount: 0,
